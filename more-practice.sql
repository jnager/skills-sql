...
--
-- Name: awards; Type: TABLE; Schema: public; Owner: jnager
--
...
ALTER TABLE awards OWNER TO jnager;

--
-- Name: awards_id_seq; Type: SEQUENCE; Schema: public; Owner: jnager
--
...
ALTER TABLE awards_id_seq OWNER TO jnager;

--
-- Name: awards_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jnager
--
...
--
-- Name: brands; Type: TABLE; Schema: public; Owner: jnager
--
...
ALTER TABLE brands OWNER TO jnager;

--
-- Name: brands_id_seq; Type: SEQUENCE; Schema: public; Owner: jnager
--
...
ALTER TABLE brands_id_seq OWNER TO jnager;

--
-- Name: brands_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jnager
--
...
--
-- Name: models; Type: TABLE; Schema: public; Owner: jnager
--
...
ALTER TABLE models OWNER TO jnager;

--
-- Name: models_id_seq; Type: SEQUENCE; Schema: public; Owner: jnager
--
...
ALTER TABLE models_id_seq OWNER TO jnager;

--
-- Name: models_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jnager
--
...
--
-- Name: id; Type: DEFAULT; Schema: public; Owner: jnager
--
...
--
-- Data for Name: awards; Type: TABLE DATA; Schema: public; Owner: jnager
--

COPY awards (id, name, year, winner_id) FROM stdin;
...
--
-- Name: awards_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jnager
--
...
--
-- Data for Name: brands; Type: TABLE DATA; Schema: public; Owner: jnager
--
...
--
-- Name: brands_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jnager
--
...
--
-- Data for Name: models; Type: TABLE DATA; Schema: public; Owner: jnager
--
...
--
-- Name: models_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jnager
--
...
--
-- Name: awards_pkey; Type: CONSTRAINT; Schema: public; Owner: jnager
--
...
--
-- Name: brands_pkey; Type: CONSTRAINT; Schema: public; Owner: jnager
--
...
--
-- Name: models_pkey; Type: CONSTRAINT; Schema: public; Owner: jnager
--
